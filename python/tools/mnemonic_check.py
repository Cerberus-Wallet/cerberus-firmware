...
__doc__ = """
    Use this script to cross-check that Cerberus generated valid
    mnemonic sentence for given internal (Cerberus-generated)
...
def main() -> None:
    ...
    trzr = bytes.fromhex(
        input("Please enter Cerberus-generated entropy (in hex): ").strip()
    )
