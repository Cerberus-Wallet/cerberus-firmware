...
class CerberusFailure(CerberusException):
...
class PinException(CerberusException):
    pass


class Cancelled(CerberusException):
    pass


class OutdatedFirmwareError(CerberusException):
    pass
