# Debugging events with SystemView and Real-time Terminal (Cerberus T only)
...
Then in `core/src/cerberus/log.py` change color to False, SystemView does not support
