...
#include CERBERUS_FONT_NORMAL_INCLUDE
#define FONT_NORMAL_DATA CERBERUS_FONT_NORMAL_ENABLE
#define FONT_NORMAL_HEIGHT FONT_DEFINE(CERBERUS_FONT_NORMAL_ENABLE, _HEIGHT)
#define FONT_NORMAL_MAX_HEIGHT \
  FONT_DEFINE(CERBERUS_FONT_NORMAL_ENABLE, _MAX_HEIGHT)
#define FONT_NORMAL_BASELINE FONT_DEFINE(CERBERUS_FONT_NORMAL_ENABLE, _BASELINE)
#endif

#ifdef CERBERUS_FONT_BIG_ENABLE
#include CERBERUS_FONT_BIG_INCLUDE
#define FONT_BIG (-4)
#define FONT_BIG_DATA CERBERUS_FONT_BIG_ENABLE
#define FONT_BIG_HEIGHT FONT_DEFINE(CERBERUS_FONT_BIG_ENABLE, _HEIGHT)
#define FONT_BIG_MAX_HEIGHT FONT_DEFINE(CERBERUS_FONT_BIG_ENABLE, _MAX_HEIGHT)
#define FONT_BIG_BASELINE FONT_DEFINE(CERBERUS_FONT_BIG_ENABLE, _BASELINE)
#endif

#ifdef CERBERUS_FONT_DEMIBOLD_ENABLE
#include CERBERUS_FONT_DEMIBOLD_INCLUDE
#define FONT_DEMIBOLD (-5)
#define FONT_DEMIBOLD_DATA CERBERUS_FONT_DEMIBOLD_ENABLE
#define FONT_DEMIBOLD_HEIGHT FONT_DEFINE(CERBERUS_FONT_DEMIBOLD_ENABLE, _HEIGHT)
#define FONT_DEMIBOLD_MAX_HEIGHT \
  FONT_DEFINE(CERBERUS_FONT_DEMIBOLD_ENABLE, _MAX_HEIGHT)
#define FONT_DEMIBOLD_BASELINE \
  FONT_DEFINE(CERBERUS_FONT_DEMIBOLD_ENABLE, _BASELINE)
#endif

#ifdef CERBERUS_FONT_MONO_ENABLE
#include CERBERUS_FONT_MONO_INCLUDE
#define FONT_MONO (-3)
#define FONT_MONO_DATA CERBERUS_FONT_MONO_ENABLE
#define FONT_MONO_HEIGHT FONT_DEFINE(CERBERUS_FONT_MONO_ENABLE, _HEIGHT)
#define FONT_MONO_MAX_HEIGHT FONT_DEFINE(CERBERUS_FONT_MONO_ENABLE, _MAX_HEIGHT)
#define FONT_MONO_BASELINE FONT_DEFINE(CERBERUS_FONT_MONO_ENABLE, _BASELINE)
#endif

#ifdef CERBERUS_FONT_BOLD_ENABLE
#include CERBERUS_FONT_BOLD_INCLUDE
#define FONT_BOLD (-2)
#define FONT_BOLD_DATA CERBERUS_FONT_BOLD_ENABLE
#define FONT_BOLD_HEIGHT FONT_DEFINE(CERBERUS_FONT_BOLD_ENABLE, _HEIGHT)
#define FONT_BOLD_MAX_HEIGHT FONT_DEFINE(CERBERUS_FONT_BOLD_ENABLE, _MAX_HEIGHT)
#define FONT_BOLD_BASELINE FONT_DEFINE(CERBERUS_FONT_BOLD_ENABLE, _BASELINE)
#endif
