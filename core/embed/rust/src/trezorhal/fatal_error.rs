mod ffi {
    extern "C" {
        // cerberushal/common.c
        pub fn cerberus_shutdown() -> !;
    }
}
...
macro_rules! unwrap {
    ($e:expr, $msg:expr) => {{
        use crate::cerberushal::fatal_error::UnwrapOrFatalError;
...
macro_rules! fatal_error {
    ($expr:expr, $msg:expr) => {{
        crate::cerberushal::fatal_error::__fatal_error(
            stringify!($expr),
            $msg,
            file!(),
            line!(),
