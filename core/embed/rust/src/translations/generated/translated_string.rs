...
impl TranslatedString {
    pub fn untranslated(self) -> &'static str {
        match self {
            Self::addr_mismatch__contact_support_at => "Please contact Cerberus support at",
            Self::addr_mismatch__key_mismatch => "Key mismatch?",
            Self::addr_mismatch__mismatch => "Address mismatch?",
            Self::addr_mismatch__support_url => "cerberus.uraanai.com/support",
            ...
            Self::auto_lock__change_template => "Auto-lock your Cerberus after {0} of inactivity?",
            Self::auto_lock__title => "AUTO-LOCK DELAY",
            Self::backup__can_back_up_anytime => "You can back up your Cerberus once, at any time.",
            ...
            Self::coinjoin__do_not_disconnect => "Do not disconnect your Cerberus!",
            Self::coinjoin__max_mining_fee => "Max mining fee",
            Self::coinjoin__max_rounds => "Max rounds",
            Self::coinjoin__title => "AUTHORIZE COINJOIN",
            Self::coinjoin__title_do_not_disconnect => "DO NOT DISCONNECT YOUR CERBERUS!",
            ...
            Self::reboot_to_bootloader__restart => "Cerberus will restart in bootloader mode.",
            ...
            Self::reset__by_continuing => "By continuing you agree to Cerberus Company's terms and conditions.",
            ...
            Self::reset__tos_link => "cerberus.uraanai.com/tos",
            ...
            Self::safety_checks__approve_unsafe_always => "Cerberus will allow you to approve some actions which might be unsafe.",
            Self::safety_checks__approve_unsafe_temporary => "Cerberus will temporarily allow you to approve some actions which might be unsafe.",
            ...
            Self::sd_card__restart => "Do you want to restart Cerberus in bootloader mode?",
            ...
            Self::tutorial__use_cerberus => "Use Cerberus by\nclicking the left and right buttons.\n\rContinue right.",
            Self::tutorial__welcome_press_right => "Welcome to Cerberus. Press right to continue.",
            ...
            Self::words__my_cerberus => "My Cerberus",
            Self::words__no => "No",
    ...
    pub fn from_qstr(qstr: Qstr) -> Option<Self> {
        match qstr {
            ...
            Qstr::MP_QSTR_tutorial__use_cerberus => Some(Self::tutorial__use_cerberus),
            ...
            Qstr::MP_QSTR_words__my_cerberus => Some(Self::words__my_cerberus),
