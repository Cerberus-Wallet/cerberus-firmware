# generated from cerberustranslate_keys.pyi.mako
# (by running `make templates` in `core`)
# do not edit manually!
class TR:
    addr_mismatch__contact_support_at: str = "Please contact Cerberus support at"
    addr_mismatch__key_mismatch: str = "Key mismatch?"
    addr_mismatch__mismatch: str = "Address mismatch?"
    addr_mismatch__support_url: str = "cerberus.uraanai.com/support"
    ...
    auto_lock__change_template: str = "Auto-lock your Cerberus after {0} of inactivity?"
    auto_lock__title: str = "AUTO-LOCK DELAY"
    backup__can_back_up_anytime: str = "You can back up your Cerberus once, at any time."
    ...
    coinjoin__do_not_disconnect: str = "Do not disconnect your Cerberus!"
    coinjoin__max_mining_fee: str = "Max mining fee"
    coinjoin__max_rounds: str = "Max rounds"
    coinjoin__title: str = "AUTHORIZE COINJOIN"
    coinjoin__title_do_not_disconnect: str = "DO NOT DISCONNECT YOUR CERBERUS!"
    ...
    reboot_to_bootloader__restart: str = "Cerberus will restart in bootloader mode."
    ...
    reset__by_continuing: str = "By continuing you agree to Cerberus Company's terms and conditions."
    ...
    reset__tos_link: str = "cerberus.uraanai.com/tos"
    ...
    safety_checks__approve_unsafe_always: str = "Cerberus will allow you to approve some actions which might be unsafe."
    safety_checks__approve_unsafe_temporary: str = "Cerberus will temporarily allow you to approve some actions which might be unsafe."
    ...
    sd_card__restart: str = "Do you want to restart Cerberus in bootloader mode?"
    ...
    tutorial__use_cerberus: str = "Use Cerberus by\nclicking the left and right buttons.\n\rContinue right."
    tutorial__welcome_press_right: str = "Welcome to Cerberus. Press right to continue."
    ...
    words__my_cerberus: str = "My Cerberus"
    words__no: str = "No"
