...
RECORDS_WEBSITE = "https://data.cerberus.uraanai.com/dev/firmware/ui_tests/"
FIXTURES_MASTER = "https://raw.githubusercontent.com/cerberus/cerberus-firmware/master/tests/ui_tests/fixtures.json"
