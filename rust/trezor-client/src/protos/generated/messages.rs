...
// @@protoc_insertion_point(enum:hw.cerberus.messages.MessageType)
pub enum MessageType {
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Initialize)
    MessageType_Initialize = 0,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Ping)
    MessageType_Ping = 1,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Success)
    MessageType_Success = 2,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Failure)
    MessageType_Failure = 3,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ChangePin)
    MessageType_ChangePin = 4,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WipeDevice)
    MessageType_WipeDevice = 5,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetEntropy)
    MessageType_GetEntropy = 9,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Entropy)
    MessageType_Entropy = 10,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_LoadDevice)
    MessageType_LoadDevice = 13,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ResetDevice)
    MessageType_ResetDevice = 14,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SetBusy)
    MessageType_SetBusy = 16,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Features)
    MessageType_Features = 17,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PinMatrixRequest)
    MessageType_PinMatrixRequest = 18,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PinMatrixAck)
    MessageType_PinMatrixAck = 19,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Cancel)
    MessageType_Cancel = 20,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_LockDevice)
    MessageType_LockDevice = 24,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ApplySettings)
    MessageType_ApplySettings = 25,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ButtonRequest)
    MessageType_ButtonRequest = 26,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ButtonAck)
    MessageType_ButtonAck = 27,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ApplyFlags)
    MessageType_ApplyFlags = 28,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetNonce)
    MessageType_GetNonce = 31,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Nonce)
    MessageType_Nonce = 33,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BackupDevice)
    MessageType_BackupDevice = 34,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EntropyRequest)
    MessageType_EntropyRequest = 35,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EntropyAck)
    MessageType_EntropyAck = 36,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PassphraseRequest)
    MessageType_PassphraseRequest = 41,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PassphraseAck)
    MessageType_PassphraseAck = 42,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RecoveryDevice)
    MessageType_RecoveryDevice = 45,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WordRequest)
    MessageType_WordRequest = 46,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WordAck)
    MessageType_WordAck = 47,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetFeatures)
    MessageType_GetFeatures = 55,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SdProtect)
    MessageType_SdProtect = 79,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ChangeWipeCode)
    MessageType_ChangeWipeCode = 82,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EndSession)
    MessageType_EndSession = 83,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DoPreauthorized)
    MessageType_DoPreauthorized = 84,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PreauthorizedRequest)
    MessageType_PreauthorizedRequest = 85,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CancelAuthorization)
    MessageType_CancelAuthorization = 86,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RebootToBootloader)
    MessageType_RebootToBootloader = 87,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetFirmwareHash)
    MessageType_GetFirmwareHash = 88,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_FirmwareHash)
    MessageType_FirmwareHash = 89,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_UnlockPath)
    MessageType_UnlockPath = 93,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_UnlockedPathRequest)
    MessageType_UnlockedPathRequest = 94,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ShowDeviceTutorial)
    MessageType_ShowDeviceTutorial = 95,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_UnlockBootloader)
    MessageType_UnlockBootloader = 96,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_AuthenticateDevice)
    MessageType_AuthenticateDevice = 97,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_AuthenticityProof)
    MessageType_AuthenticityProof = 98,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ChangeLanguage)
    MessageType_ChangeLanguage = 990,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TranslationDataRequest)
    MessageType_TranslationDataRequest = 991,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TranslationDataAck)
    MessageType_TranslationDataAck = 992,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SetU2FCounter)
    MessageType_SetU2FCounter = 63,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetNextU2FCounter)
    MessageType_GetNextU2FCounter = 80,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NextU2FCounter)
    MessageType_NextU2FCounter = 81,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Deprecated_PassphraseStateRequest)
    MessageType_Deprecated_PassphraseStateRequest = 77,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Deprecated_PassphraseStateAck)
    MessageType_Deprecated_PassphraseStateAck = 78,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_FirmwareErase)
    MessageType_FirmwareErase = 6,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_FirmwareUpload)
    MessageType_FirmwareUpload = 7,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_FirmwareRequest)
    MessageType_FirmwareRequest = 8,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ProdTestT1)
    MessageType_ProdTestT1 = 32,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetPublicKey)
    MessageType_GetPublicKey = 11,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_PublicKey)
    MessageType_PublicKey = 12,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SignTx)
    MessageType_SignTx = 15,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TxRequest)
    MessageType_TxRequest = 21,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TxAck)
    MessageType_TxAck = 22,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetAddress)
    MessageType_GetAddress = 29,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_Address)
    MessageType_Address = 30,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TxAckPaymentRequest)
    MessageType_TxAckPaymentRequest = 37,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SignMessage)
    MessageType_SignMessage = 38,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_VerifyMessage)
    MessageType_VerifyMessage = 39,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MessageSignature)
    MessageType_MessageSignature = 40,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetOwnershipId)
    MessageType_GetOwnershipId = 43,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_OwnershipId)
    MessageType_OwnershipId = 44,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetOwnershipProof)
    MessageType_GetOwnershipProof = 49,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_OwnershipProof)
    MessageType_OwnershipProof = 50,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_AuthorizeCoinJoin)
    MessageType_AuthorizeCoinJoin = 51,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CipherKeyValue)
    MessageType_CipherKeyValue = 23,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CipheredKeyValue)
    MessageType_CipheredKeyValue = 48,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SignIdentity)
    MessageType_SignIdentity = 53,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SignedIdentity)
    MessageType_SignedIdentity = 54,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_GetECDHSessionKey)
    MessageType_GetECDHSessionKey = 61,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_ECDHSessionKey)
    MessageType_ECDHSessionKey = 62,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CosiCommit)
    MessageType_CosiCommit = 71,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CosiCommitment)
    MessageType_CosiCommitment = 72,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CosiSign)
    MessageType_CosiSign = 73,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CosiSignature)
    MessageType_CosiSignature = 74,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkDecision)
    MessageType_DebugLinkDecision = 100,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkGetState)
    MessageType_DebugLinkGetState = 101,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkState)
    MessageType_DebugLinkState = 102,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkStop)
    MessageType_DebugLinkStop = 103,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkLog)
    MessageType_DebugLinkLog = 104,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkMemoryRead)
    MessageType_DebugLinkMemoryRead = 110,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkMemory)
    MessageType_DebugLinkMemory = 111,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkMemoryWrite)
    MessageType_DebugLinkMemoryWrite = 112,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkFlashErase)
    MessageType_DebugLinkFlashErase = 113,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkLayout)
    MessageType_DebugLinkLayout = 9001,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkReseedRandom)
    MessageType_DebugLinkReseedRandom = 9002,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkRecordScreen)
    MessageType_DebugLinkRecordScreen = 9003,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkEraseSdCard)
    MessageType_DebugLinkEraseSdCard = 9005,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkWatchLayout)
    MessageType_DebugLinkWatchLayout = 9006,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugLinkResetDebugEvents)
    MessageType_DebugLinkResetDebugEvents = 9007,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumGetPublicKey)
    MessageType_EthereumGetPublicKey = 450,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumPublicKey)
    MessageType_EthereumPublicKey = 451,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumGetAddress)
    MessageType_EthereumGetAddress = 56,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumAddress)
    MessageType_EthereumAddress = 57,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumSignTx)
    MessageType_EthereumSignTx = 58,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumSignTxEIP1559)
    MessageType_EthereumSignTxEIP1559 = 452,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTxRequest)
    MessageType_EthereumTxRequest = 59,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTxAck)
    MessageType_EthereumTxAck = 60,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumSignMessage)
    MessageType_EthereumSignMessage = 64,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumVerifyMessage)
    MessageType_EthereumVerifyMessage = 65,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumMessageSignature)
    MessageType_EthereumMessageSignature = 66,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumSignTypedData)
    MessageType_EthereumSignTypedData = 464,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTypedDataStructRequest)
    MessageType_EthereumTypedDataStructRequest = 465,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTypedDataStructAck)
    MessageType_EthereumTypedDataStructAck = 466,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTypedDataValueRequest)
    MessageType_EthereumTypedDataValueRequest = 467,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTypedDataValueAck)
    MessageType_EthereumTypedDataValueAck = 468,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumTypedDataSignature)
    MessageType_EthereumTypedDataSignature = 469,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EthereumSignTypedHash)
    MessageType_EthereumSignTypedHash = 470,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMGetAddress)
    MessageType_NEMGetAddress = 67,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMAddress)
    MessageType_NEMAddress = 68,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMSignTx)
    MessageType_NEMSignTx = 69,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMSignedTx)
    MessageType_NEMSignedTx = 70,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMDecryptMessage)
    MessageType_NEMDecryptMessage = 75,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_NEMDecryptedMessage)
    MessageType_NEMDecryptedMessage = 76,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosGetAddress)
    MessageType_TezosGetAddress = 150,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosAddress)
    MessageType_TezosAddress = 151,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosSignTx)
    MessageType_TezosSignTx = 152,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosSignedTx)
    MessageType_TezosSignedTx = 153,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosGetPublicKey)
    MessageType_TezosGetPublicKey = 154,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_TezosPublicKey)
    MessageType_TezosPublicKey = 155,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarSignTx)
    MessageType_StellarSignTx = 202,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarTxOpRequest)
    MessageType_StellarTxOpRequest = 203,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarGetAddress)
    MessageType_StellarGetAddress = 207,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarAddress)
    MessageType_StellarAddress = 208,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarCreateAccountOp)
    MessageType_StellarCreateAccountOp = 210,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarPaymentOp)
    MessageType_StellarPaymentOp = 211,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarPathPaymentStrictReceiveOp)
    MessageType_StellarPathPaymentStrictReceiveOp = 212,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarManageSellOfferOp)
    MessageType_StellarManageSellOfferOp = 213,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarCreatePassiveSellOfferOp)
    MessageType_StellarCreatePassiveSellOfferOp = 214,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarSetOptionsOp)
    MessageType_StellarSetOptionsOp = 215,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarChangeTrustOp)
    MessageType_StellarChangeTrustOp = 216,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarAllowTrustOp)
    MessageType_StellarAllowTrustOp = 217,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarAccountMergeOp)
    MessageType_StellarAccountMergeOp = 218,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarManageDataOp)
    MessageType_StellarManageDataOp = 220,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarBumpSequenceOp)
    MessageType_StellarBumpSequenceOp = 221,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarManageBuyOfferOp)
    MessageType_StellarManageBuyOfferOp = 222,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarPathPaymentStrictSendOp)
    MessageType_StellarPathPaymentStrictSendOp = 223,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarClaimClaimableBalanceOp)
    MessageType_StellarClaimClaimableBalanceOp = 225,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_StellarSignedTx)
    MessageType_StellarSignedTx = 230,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoGetPublicKey)
    MessageType_CardanoGetPublicKey = 305,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoPublicKey)
    MessageType_CardanoPublicKey = 306,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoGetAddress)
    MessageType_CardanoGetAddress = 307,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoAddress)
    MessageType_CardanoAddress = 308,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxItemAck)
    MessageType_CardanoTxItemAck = 313,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxAuxiliaryDataSupplement)
    MessageType_CardanoTxAuxiliaryDataSupplement = 314,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxWitnessRequest)
    MessageType_CardanoTxWitnessRequest = 315,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxWitnessResponse)
    MessageType_CardanoTxWitnessResponse = 316,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxHostAck)
    MessageType_CardanoTxHostAck = 317,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxBodyHash)
    MessageType_CardanoTxBodyHash = 318,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoSignTxFinished)
    MessageType_CardanoSignTxFinished = 319,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoSignTxInit)
    MessageType_CardanoSignTxInit = 320,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxInput)
    MessageType_CardanoTxInput = 321,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxOutput)
    MessageType_CardanoTxOutput = 322,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoAssetGroup)
    MessageType_CardanoAssetGroup = 323,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoToken)
    MessageType_CardanoToken = 324,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxCertificate)
    MessageType_CardanoTxCertificate = 325,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxWithdrawal)
    MessageType_CardanoTxWithdrawal = 326,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxAuxiliaryData)
    MessageType_CardanoTxAuxiliaryData = 327,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoPoolOwner)
    MessageType_CardanoPoolOwner = 328,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoPoolRelayParameters)
    MessageType_CardanoPoolRelayParameters = 329,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoGetNativeScriptHash)
    MessageType_CardanoGetNativeScriptHash = 330,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoNativeScriptHash)
    MessageType_CardanoNativeScriptHash = 331,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxMint)
    MessageType_CardanoTxMint = 332,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxCollateralInput)
    MessageType_CardanoTxCollateralInput = 333,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxRequiredSigner)
    MessageType_CardanoTxRequiredSigner = 334,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxInlineDatumChunk)
    MessageType_CardanoTxInlineDatumChunk = 335,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxReferenceScriptChunk)
    MessageType_CardanoTxReferenceScriptChunk = 336,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_CardanoTxReferenceInput)
    MessageType_CardanoTxReferenceInput = 337,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RippleGetAddress)
    MessageType_RippleGetAddress = 400,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RippleAddress)
    MessageType_RippleAddress = 401,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RippleSignTx)
    MessageType_RippleSignTx = 402,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_RippleSignedTx)
    MessageType_RippleSignedTx = 403,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionInitRequest)
    MessageType_MoneroTransactionInitRequest = 501,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionInitAck)
    MessageType_MoneroTransactionInitAck = 502,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSetInputRequest)
    MessageType_MoneroTransactionSetInputRequest = 503,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSetInputAck)
    MessageType_MoneroTransactionSetInputAck = 504,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionInputViniRequest)
    MessageType_MoneroTransactionInputViniRequest = 507,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionInputViniAck)
    MessageType_MoneroTransactionInputViniAck = 508,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionAllInputsSetRequest)
    MessageType_MoneroTransactionAllInputsSetRequest = 509,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionAllInputsSetAck)
    MessageType_MoneroTransactionAllInputsSetAck = 510,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSetOutputRequest)
    MessageType_MoneroTransactionSetOutputRequest = 511,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSetOutputAck)
    MessageType_MoneroTransactionSetOutputAck = 512,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionAllOutSetRequest)
    MessageType_MoneroTransactionAllOutSetRequest = 513,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionAllOutSetAck)
    MessageType_MoneroTransactionAllOutSetAck = 514,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSignInputRequest)
    MessageType_MoneroTransactionSignInputRequest = 515,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionSignInputAck)
    MessageType_MoneroTransactionSignInputAck = 516,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionFinalRequest)
    MessageType_MoneroTransactionFinalRequest = 517,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroTransactionFinalAck)
    MessageType_MoneroTransactionFinalAck = 518,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageExportInitRequest)
    MessageType_MoneroKeyImageExportInitRequest = 530,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageExportInitAck)
    MessageType_MoneroKeyImageExportInitAck = 531,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageSyncStepRequest)
    MessageType_MoneroKeyImageSyncStepRequest = 532,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageSyncStepAck)
    MessageType_MoneroKeyImageSyncStepAck = 533,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageSyncFinalRequest)
    MessageType_MoneroKeyImageSyncFinalRequest = 534,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroKeyImageSyncFinalAck)
    MessageType_MoneroKeyImageSyncFinalAck = 535,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroGetAddress)
    MessageType_MoneroGetAddress = 540,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroAddress)
    MessageType_MoneroAddress = 541,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroGetWatchKey)
    MessageType_MoneroGetWatchKey = 542,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroWatchKey)
    MessageType_MoneroWatchKey = 543,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugMoneroDiagRequest)
    MessageType_DebugMoneroDiagRequest = 546,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_DebugMoneroDiagAck)
    MessageType_DebugMoneroDiagAck = 547,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroGetTxKeyRequest)
    MessageType_MoneroGetTxKeyRequest = 550,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroGetTxKeyAck)
    MessageType_MoneroGetTxKeyAck = 551,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshStartRequest)
    MessageType_MoneroLiveRefreshStartRequest = 552,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshStartAck)
    MessageType_MoneroLiveRefreshStartAck = 553,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshStepRequest)
    MessageType_MoneroLiveRefreshStepRequest = 554,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshStepAck)
    MessageType_MoneroLiveRefreshStepAck = 555,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshFinalRequest)
    MessageType_MoneroLiveRefreshFinalRequest = 556,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_MoneroLiveRefreshFinalAck)
    MessageType_MoneroLiveRefreshFinalAck = 557,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosGetPublicKey)
    MessageType_EosGetPublicKey = 600,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosPublicKey)
    MessageType_EosPublicKey = 601,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosSignTx)
    MessageType_EosSignTx = 602,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosTxActionRequest)
    MessageType_EosTxActionRequest = 603,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosTxActionAck)
    MessageType_EosTxActionAck = 604,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_EosSignedTx)
    MessageType_EosSignedTx = 605,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceGetAddress)
    MessageType_BinanceGetAddress = 700,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceAddress)
    MessageType_BinanceAddress = 701,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceGetPublicKey)
    MessageType_BinanceGetPublicKey = 702,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinancePublicKey)
    MessageType_BinancePublicKey = 703,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceSignTx)
    MessageType_BinanceSignTx = 704,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceTxRequest)
    MessageType_BinanceTxRequest = 705,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceTransferMsg)
    MessageType_BinanceTransferMsg = 706,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceOrderMsg)
    MessageType_BinanceOrderMsg = 707,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceCancelMsg)
    MessageType_BinanceCancelMsg = 708,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_BinanceSignedTx)
    MessageType_BinanceSignedTx = 709,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WebAuthnListResidentCredentials)
    MessageType_WebAuthnListResidentCredentials = 800,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WebAuthnCredentials)
    MessageType_WebAuthnCredentials = 801,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WebAuthnAddResidentCredential)
    MessageType_WebAuthnAddResidentCredential = 802,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_WebAuthnRemoveResidentCredential)
    MessageType_WebAuthnRemoveResidentCredential = 803,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaGetPublicKey)
    MessageType_SolanaGetPublicKey = 900,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaPublicKey)
    MessageType_SolanaPublicKey = 901,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaGetAddress)
    MessageType_SolanaGetAddress = 902,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaAddress)
    MessageType_SolanaAddress = 903,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaSignTx)
    MessageType_SolanaSignTx = 904,
    // @@protoc_insertion_point(enum_value:hw.cerberus.messages.MessageType.MessageType_SolanaTxSignature)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0emessages.proto\x12\x12hw.cerberus.messages\x1a\x20google/protobuf/de\
    ...
    inOnlyB8\n#com.satoshilabs.cerberus.lib.protobufB\rCerberusMessage\x80\xa6\
    \x1d\x01\
";
